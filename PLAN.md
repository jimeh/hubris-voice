...
All targets use clipboard paste with transient and autogenerated markers.
Accessibility supplies secure-field checks, placement, and best-effort text
context and confirmation; it is never used to write text. Paste outcomes distinguish confirmed insertion,
